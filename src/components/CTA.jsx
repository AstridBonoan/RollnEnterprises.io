export default function CTA() {
  return (
    <section
      id="contact"
      className="section-shell section-divider relative w-full overflow-hidden bg-[#0f1618]"
      aria-labelledby="cta-heading"
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute top-0 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-teal-400/10 blur-3xl" />
      ...
      <div className="section-inner relative px-6 py-16 text-center sm:px-10 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-2xl">
          <p className="eyebrow mb-4 text-teal-300/60">Get Involved</p>
          <h2 id="cta-heading" className="display-md text-teal-50">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
            ...
            <a href="#products" className="link-cta link-cta-copper">
              Explore products
            </a>
          </div>
          ...
          <address className="mt-12 not-italic">
            <p className="text-sm text-teal-100/50">
              ...
              <a
                href="mailto:contact@rollnenterprises.io"
                className="font-medium text-teal-100/80 underline-offset-4 transition-colors hover:text-teal-50 hover:underline"
              >
