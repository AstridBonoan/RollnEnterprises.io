...
const socialLinks = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/AstridBonoan/RollnEnterprises.io',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="border-t border-slate-800 bg-slate-dark" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          ...
          >
            ...
            <span className="text-lg font-bold text-white">RollnEnterprises</span>
          </a>
        ...
        <div className="mt-10 border-t border-slate-800 pt-8 text-center">
          <p className="text-sm text-slate-500">
            &copy; 2026 RollnEnterprises. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
