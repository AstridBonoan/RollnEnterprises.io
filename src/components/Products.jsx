...
export default function Products() {
  return (
    <section id="products" className="section-shell w-full border-t border-slate-200 bg-white" aria-labelledby="products-heading">
      <div className="section-inner py-16 sm:py-20 lg:py-24">
        ...
        <article
          className={`product-tile mx-auto flex max-w-2xl flex-col overflow-hidden rounded-2xl ${product.bg} ring-1 ring-black/5`}
        >
